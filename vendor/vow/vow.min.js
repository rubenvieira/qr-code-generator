 ...
 */ (function (e) {
  var t,
    n = (function () {
      ...
      if (i) {
        ...
        return (
          new i(r).observe(o, { characterData: !0 }),
          function (e) {
            n(e) && (o.data = s *= -1);
          }
        );
      ...
      if (e.postMessage) {
        ...
        if (u) {
          var f = "__promise" + Math.random() + "_" + new Date(),
            l = function (e) {
              e.data === f && (e.stopPropagation && e.stopPropagation(), r());
            };
          return (
            e.addEventListener
      ...
      if ("onreadystatechange" in c.createElement("script")) {
        var h = function () {
          ...
          ((e.onreadystatechange = function () {
            ...
            (c.documentElement || c.body).appendChild(e));
        };
        return function (e) {
          n(e) && h();
        };
    ...
    h = e.PromiseRejectionEvent
      ? function (t, n) {
          new e.PromiseRejectionEvent("unhandledrejection", {
            promise: n,
            reason: t,
          });
        }
  ...
  var d = { PENDING: 0, RESOLVED: 1, FULFILLED: 2, REJECTED: 3 },
    v = function (e) {
      ((this._value = t),
        (this._status = d.PENDING),
        (this._shouldEmitUnhandledRejection = !0),
  ...
  v.prototype = {
    ...
    isResolved: function () {
      return this._status !== d.PENDING;
    },
    isFulfilled: function () {
      return this._status === d.FULFILLED;
    },
    isRejected: function () {
      return this._status === d.REJECTED;
    },
    then: function (e, t, n, r) {
      this._shouldEmitUnhandledRejection = !1;
      var i = new p();
    ...
    _vow: !0,
    _resolve: function (e) {
      if (this._status > d.RESOLVED) return;
      if (e === this) {
        this._reject(TypeError("Can't resolve promise with itself"));
        return;
      }
      this._status = d.RESOLVED;
      if (e && !!e._vow) {
        e.isFulfilled()
          ? this._fulfill(e.valueOf())
          : e.isRejected()
            ? ((e._shouldEmitUnhandledRejection = !1),
    ...
    _addCallbacks: function (e, n, r, s, o) {
      (r && !i(r) ? ((o = r), (r = t)) : s && !i(s) && ((o = s), (s = t)),
        r && (this._shouldEmitUnhandledRejection = !1));
      var u;
      (this.isRejected() ||
        ((u = { defer: e, fn: i(n) ? n : t, ctx: o }),
        this.isFulfilled()
          ? this._callCallbacks([u], this._value)
          : this._fulfilledCallbacks.push(u)),
        this.isFulfilled() ||
          ((u = { defer: e, fn: r, ctx: o }),
          this.isRejected()
            ? this._callCallbacks([u], this._value)
            : this._rejectedCallbacks.push(u)),
        this._status <= d.RESOLVED &&
          this._progressCallbacks.push({ defer: e, fn: s, ctx: o }));
    },
      ...
      n(function () {
        ...
        while (n < r) {
          ...
          if (f) {
            ...
            i ? a.resolve(c) : a.notify(c);
          } else s ? a.resolve(t) : o ? a.reject(t) : a.notify(t);
        }
      });
    },
  };
  ...
  for (var g in m) m.hasOwnProperty(g) && (v[g] = m[g]);
  var y = {
      Deferred: p,
      Promise: v,
      defer: function () {
      ...
      invoke: function (t, n) {
        ...
        try {
          return y.resolve(i ? t.apply(e, i) : t.call(e));
        } catch (o) {
          return y.reject(o);
        }
      },
      ...
      allResolved: function (e) {
        ...
        return (y._forEach(e, o, o, t.notify, t, r), t.promise());
      },
        ...
        return y.allResolved(e).then(function () {
          ...
          while (o < s)
            ((l = n[o++]),
              ...
              y.isRejected(c)
                ? (r || (r = t ? [] : {}),
                  t ? r.push(c.valueOf()) : (r[l] = c.valueOf()))
                : r || ((i || (i = t ? [] : {}))[l] = y.valueOf(c)));
          if (r) throw r;
          return i;
        });
      },
      ...
      anyResolved: function (e) {
        var t = new p(),
          n = e.length;
        return n
          ? (y._forEach(e, t.resolve, t.reject, t.notify, t), t.promise())
      ...
      _forEach: function (e, t, n, r, i, s) {
        var o = s ? s.length : e.length,
          u = 0;
        while (u < o) (y.when(e[s ? s[u] : u], c(t, u), n, r, i), ++u);
      },
